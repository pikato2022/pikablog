...
[Snap capstone project](https://gitlab.com/nguyentloc99/snap-backend): A project management tool for small to medium team size. Using EVM technique to visualize the status of cost and schedule of a project.
